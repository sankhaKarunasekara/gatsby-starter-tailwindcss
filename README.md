...
gatsby new my-new-site https://github.com/lukebennett88/gatsby-starter-tailwindcss
```
...
3. **`.eslintignore`**: This file tells ESLint to ignore specific files and directories. [More information here.](https://eslint.org/docs/user-guide/configuring#eslintignore)

4. **`.eslintrc.js`**: This file tells ESLint what rules to use when linting your code. [More information here.](https://eslint.org/docs/user-guide/configuring)
